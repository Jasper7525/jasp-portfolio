        ...
        <div className="max-w-6xl mx-auto glass rounded-3xl overflow-hidden flex flex-col lg:flex-row">
          ...
          <div className="flex-[1.5] p-12 bg-slate-900">
            <form className="space-y-6">
              ...
              <button 
                type="submit"
                className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-4 rounded-xl transition-all shadow-lg shadow-indigo-600/30 transform hover:scale-[1.02]"
              >
                Send Message
              </button>
            </form>
